...
import ToastAlert from "@/components/pages/Store/ToastAlert";
import UrgencyTicker from "@/components/pages/Store/UrgencyTicker";

import type { Metadata } from 'next'

export const metadata: Metadata = {
  title: "Was Your Home in the Storm's Path? | Texas Precision Roofing",
  description: "Enter your ZIP code to instantly check if your home was in a recent storm damage zone. Free professional roof inspection from Texas Precision Roofing for affected  homeowners.",
}
